...
public class ModUpgrades {
	...
	public static final Upgrade ICEBALL = new IceballUpgrade(-32, -8, null, null, UpgradeSprite.GEM_SPRITE).setRequirements(new ItemStack(Items.POTATO), new ItemStack(Items.ACACIA_BOAT), new ItemStack(Blocks.JUKEBOX));
