...
public interface SoulEssenceContainer {
    ...
    default int getSoul(ItemStack stack, @Nullable World world, SoulType type) {
    ...
    default void setSoul(ItemStack stack, @Nullable World world, SoulType type, int amount) {
        //If there is no tag
        if (!stack.hasNbt()) {
    ...
    default boolean subtractSoul(ItemStack stack, @Nullable World world, SoulType type, int amount) {
